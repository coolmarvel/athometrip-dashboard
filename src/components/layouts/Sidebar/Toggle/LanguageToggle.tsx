...
const LanguageToggle = () => {
  ...
  return (
    <ChangerBase ariaLabel={'Toggle language'} label={i18n.language === 'ko' ? t('English') : t('Korean')} onToggle={handleToggle}>
      <Icon as={i18n.language === 'ko' ? TbCircleLetterE : TbCircleLetterK} w={'5'} h={'5'} />
    </ChangerBase>
  );
};
