...
import { ColorToggler, LanguageToggler, LayoutToggler, Logo, PrimaryColorChanger } from '@/components';
...
const VerticalLayoutHeader = () => {
  ...
  return (
    <Box as={'header'} display={'flex'} flexDirection={'column'} gap={'4'} mb={'4'} pt={'10'} w={{ base: '100%', xl: 'container.xl' }}>
      <Flex justify={'flex-end'} gap={'4'} px={{ base: '4', xl: '0' }}>
        ...
        {me ? (
          ...
          <Button rightIcon={<RiLoginBoxLine />} onClick={() => push(toUrl(PageRoutes.Signin))}>
            {t('Sign In')}
          </Button>
        )}
      </Flex>
