...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'GET':
      ...
      if (page && limit) return getToNYNJEWRsByPage(req, res);
    case 'POST':
...
const productId = process.env.NEXT_PUBLIC_TO_NYNJ_EWR as string;

const getToNYNJEWRsByPage = async (req: NextApiRequest, res: NextApiResponse) => {
