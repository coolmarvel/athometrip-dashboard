...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'POST':
      return refetchMetroDocentPainting(req, res);
    default:
...
const productId = process.env.NEXT_PUBLIC_METRO_DOCENT_PAINTING as string;

const refetchMetroDocentPainting = async (req: NextApiRequest, res: NextApiResponse) => {
