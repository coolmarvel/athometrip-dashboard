...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'GET':
      ...
      if (page && limit) return getNiagaraTwoDaysByPage(req, res);
    case 'POST':
...
const productId = '166831,168762';
const tourName = 'niagara-oneday-twodays';
const url = process.env.NEXT_PUBLIC_APIS_URL;

const getNiagaraTwoDaysByPage = async (req: NextApiRequest, res: NextApiResponse) => {
