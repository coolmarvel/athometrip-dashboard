...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'GET':
      ...
      if (page && limit) return getNiagaraOneDayAthometripByPage(req, res);
    case 'POST':
...
const productId = process.env.NEXT_PUBLIC_NIAGARA_ONEDAY_ATHOMETRIP as string;

const getNiagaraOneDayAthometripByPage = async (req: NextApiRequest, res: NextApiResponse) => {
