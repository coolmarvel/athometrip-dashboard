...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'GET':
      ...
      if (page && limit) return getGuggenheimDocentByPage(req, res);
    case 'POST':
...
const productId = process.env.NEXT_PUBLIC_GUGGENHEIM_DOCENT as string;

const getGuggenheimDocentByPage = async (req: NextApiRequest, res: NextApiResponse) => {
