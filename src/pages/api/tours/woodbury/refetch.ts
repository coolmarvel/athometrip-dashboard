...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  switch (req.method) {
    case 'POST':
      return refetchWoodbury(req, res);
    default:
...
const productId = process.env.NEXT_PUBLIC_WOODBURY as string;

const refetchWoodbury = async (req: NextApiRequest, res: NextApiResponse) => {
